...
export const nl = {
  ...
  athlete: {
    ...
    training: {
      title: "Training",
      open: "Open training",
      views: { week: "Week", agenda: "Agenda", progress: "Voortgang" },
      thisWeek: "Deze week",
      today: "Vandaag",
      ...
      planWeek: "Week",
      noPlan: "Geen plan",
      noSessions: "Geen trainingen deze week.",
      mainKata: "hoofdkata",
      noKata: "geen kata",
      parts: {
        1: "Warming-up",
      ...
      rounds: "rondes",
      reps: "herh.",
      restRep: "rust per herh.",
      restSection: "per deel",
      vest: "vest",
      done: "Gedaan",
      ...
      skip: "Overslaan",
      unskip: "Toch gedaan",
      actualReps: "Gedaan aantal",
      save: "Opslaan",
      saved: "Opgeslagen",
      athleteNotes: "Mijn notities",
      athleteNotesHint: "Hoe ging het? Wat viel op?",
      notes: "Notities",
      coachNotes: "Coachnotities",
      missingTimings: "Tijden ontbreken voor",
      agenda: {
        upcoming: "Komende trainingen",
        past: "Eerder",
        empty: "Niets gepland.",
      },
      progress: {
        ...
        score: "Score",
        timings: "Sectietijden (seconden)",
        noCards: "Nog geen scorekaarten.",
        defaultTiming: "standaardtijd",
        section: "Deel",
      },
      print: "Print",
      nextSession: "Volgende training",
      noNextSession: "Geen training gepland.",
      sessionsThisWeek: "trainingen",
    },
    learnings: {
      title: "Inzichten",
      empty: "Nog geen inzichten.",
      delete: "Verwijderen",
      confirmDelete: "Dit inzicht verwijderen?",
      byAi: "AI",
      byCoach: "Coach",
      global: "Algemeen",
    },
  ...
  feedback: {
    ...
    reel: {
      ...
      locked:
        "Het gesprek is afgerond — de reel kan niet meer gewijzigd worden.",
